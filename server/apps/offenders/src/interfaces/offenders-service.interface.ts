import { CreateOffenderDto, IPageable, MapBoundsDto, OffenderDto, OffendersSearchFilter, Page, UpdateOffenderDto } from '@vsp/common';
...
export interface IOffendersService {
  ...
  delete(offenderId: string): Promise<OffenderDto>;
