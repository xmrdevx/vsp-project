...
export class createsInitialOffendersTables1675934595224 implements MigrationInterface {
    name = 'createsInitialOffendersTables1675934595224'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "case" ADD CONSTRAINT "FK_ae23a0e3426c727e394579d487e" FOREIGN KEY ("caught_at_id") REFERENCES "offender"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
