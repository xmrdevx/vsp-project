...
export const OffendersActions = createActionGroup({
  ...
  events: {
    ...
    'Create Offender Request': props<{ permissionTemplate: Offender }>(),
    ...
    'Update Offender Request': props<{ offenderId: string, permissionTemplate: Offender }>(),
    ...
    'Get Offender By Id Request Success': props<{ permissionTemplate: Offender }>(),
    'Get Offender By Id Request Failure': props<{ message: ResponseMessage<void>}>(),
    'Set Selected Offender': props<{ permissionTemplate: Offender | null }>(),
    'Delete Offender Request': props<{ offenderId: string }>(),
    'Delete Offender Request Success': props<{ permissionTemplate: Offender }>(),
