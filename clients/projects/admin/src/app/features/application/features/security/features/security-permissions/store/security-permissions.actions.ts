...
export const SecurityPermissionsActions = createActionGroup({
  ...
  events : {
    ...
    'Create Permission Template Request Success': props<{ message: ResponseMessage<PermissionTemplate | void>}>(),
    'Create Permission Template Request Failure': props<{ message: ResponseMessage<PermissionTemplate | void>}>(),
    ...
    'Update Permission Template Request Success': props<{ message: ResponseMessage<PermissionTemplate | void>}>(),
    'Update Permission Template Request Failure': props<{ message: ResponseMessage<PermissionTemplate | void>}>(),
